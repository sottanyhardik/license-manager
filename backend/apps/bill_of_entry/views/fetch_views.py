...
from .common import forms, logger
from backend.lmanagement.tasks import fetch_data_to_model


class BillOfEntryFetchView(FormView):
    template_name = 'bill_of_entry/../templates/bill_of_entry/fetch.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            from apps.bill_of_entry.scripts.boe import fetch_cookies, fetch_captcha
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            from apps.bill_of_entry.scripts.utils import port_dict
        except Exception:
