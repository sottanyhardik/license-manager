...
app = apps.get_app_config('shipping_bill')
for model_name, model in app.models.items():
    ...
    model_admin.search_fields = model.admin_search_fields if hasattr(model, 'admin_search_fields') else tuple([field.name for field in model._meta.fields])
