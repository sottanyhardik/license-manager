    ...
    items_and_filters = [
        ...
        ('FOOD FLAVOUR BISCUITS',
         (Q(description__icontains="relevant food flavour") | Q(description__icontains="FOOD FLAVOUR") | Q(
             description__icontains="relevant (food flour") | Q(description__icontains="Flavouring Agent") | Q(description__icontains=" Flavour Improvers") | Q(
        ...
        ('JUICE', (Q(description__icontains="Relevant Fruit") | Q(description__icontains='FRUITS FLAVOUR')| Q(description__icontains='Fruit Flavour')) &
         Q(license__export_license__norm_class__norm_class='E5')),
        ...
        ('OTHER CONFECTIONERY INGREDIENTS',
         Q(description__icontains="other confectionery ingredients") | Q(description__icontains="nut & nut products") | Q(description__icontains="Fruits and Nuts Product")),
        ...
        ('PP', (Q(hs_code__hs_code__startswith='39021000') | Q(description__icontains='Polypropylene') | Q(description__icontains='pp granules') | Q(
