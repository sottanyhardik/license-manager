...
export default function LicensePlanningWorkspace() {
    ...
    const allocationHasUnsavedChanges = !!draft?.id && !!allocationDraft && JSON.stringify(allocationDraft) !== JSON.stringify(savedAllocation);
