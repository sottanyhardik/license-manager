    ...
    const handleExport = async () => {
        ...
        try {
            const response = await api.get(
                `license/reports/active-licenses/?format=excel&days=${days}`,
                {
                    responseType: 'blob',
                }
            );
            ...
            link.href = url;
            link.setAttribute('download', `active_licenses_${days}_days.xlsx`);
        ...
        <div className="container-fluid">
            <div className="row mb-4">
                <div className="col-12">
                    <h2>Active Licenses Report</h2>
                    <p className="text-muted">
                        Export all active licenses from (today - N days) through all future dates (2026, 2027, etc.)
                    </p>
                </div>
            </div>
