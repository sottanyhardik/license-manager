...
urlpatterns = [
    ...
    path('<slug:license>/item/update', login_required(views.LicenseItemListUpdateView.as_view()), name='license-item-update'),
    ...
    path('report/2015/biscuits/other/', login_required(views.PDFNewBiscuitsOtherReportView.as_view()), name='report_new_biscuits_other'),
    ...
    path('confectinery/2009/expiried', login_required(views.PDFConfectioneryOldExpiredReportView.as_view()), name='confectinery_expiried_old'),
    path('confectinery/other/2009/expiried', login_required(views.PDFOtherConfectioneryOldExpiredReportView.as_view()), name='confectinery_other_expiried_old'),
