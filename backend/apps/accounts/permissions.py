...
"""
RBAC permission classes for the License Manager.

Role codes (Group names) replicated exactly from:
  legacy/backend/apps/accounts/permissions.py

The 12 distinct role codes in use:
  LICENSE_MANAGER, LICENSE_VIEWER, TRADE_MANAGER, TRADE_VIEWER,
  ALLOTMENT_MANAGER, ALLOTMENT_VIEWER, BOE_MANAGER, BOE_VIEWER,
  INCENTIVE_LICENSE_MANAGER, INCENTIVE_LICENSE_VIEWER,
  USER_MANAGER, REPORT_VIEWER,
  ACCOUNT_ACCESS, TL_GENERATE, LEDGER_MANAGER
  (LEDGER_MANAGER / ACCOUNT_ACCESS / TL_GENERATE are supplemental role codes)

BaseRolePermission drives all standard permission classes:
  - superusers always pass
  - safe methods (GET/HEAD/OPTIONS) checked against required_roles_for_read
  - unsafe methods checked against required_roles_for_write
  - empty required list for write => write is denied
"""
