...
class BillOfEntryTable(dt2.Table):
    ...
    class Meta:
        ...
        fields = ['counter', 'company', 'bill_of_entry_number', 'bill_of_entry_date', 'amount_inr', 'amount_fc',
                  'quantity', 'port', 'exchange_rate',
                  'product_name', 'allotment', 'invoice_no', 'licenses', 'appraisement']
