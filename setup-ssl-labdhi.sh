...
echo "========================================="
echo "SSL Setup for License Manager (Labdhi)"
echo "========================================="
...
sudo cp /etc/nginx/sites-available/license-manager /etc/nginx/sites-available/license-manager.backup.$(date +%Y%m%d_%H%M%S) || true
...
server {
    listen 80;
    server_name 64.227.129.26 labdhi.duckdns.org;
...
# Step 3: Enable temporary config and remove old configs
...
server {
    ...
    # SSL Certificate
    ssl_certificate /etc/letsencrypt/live/labdhi.duckdns.org/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/labdhi.duckdns.org/privkey.pem;
    ...
    ssl_trusted_certificate /etc/letsencrypt/live/labdhi.duckdns.org/chain.pem;
...
echo "  /etc/letsencrypt/live/labdhi.duckdns.org/"
echo ""
echo "Auto-renewal:"
...
echo "  - https://labdhi.duckdns.org"
echo "  - https://64.227.129.26"
echo ""
