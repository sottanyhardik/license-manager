...
urlpatterns = [
    ...
    path('biscuits/new/expiried', login_required(views.PDFBiscuitsNewExpiryReportView.as_view()), name='biscuits_expiried'),
    path('confectinery/new/expiried', login_required(views.PDFConfectioneryNewExpiredReportView.as_view()), name='confectinery_expiried'),
    path('biscuits/old/expiried', login_required(views.PDFBiscuitsOldExpiryReportView.as_view()), name='biscuits_expiried'),
    path('confectinery/old/expiried', login_required(views.PDFConfectioneryOldExpiredReportView.as_view()), name='confectinery_expiried'),
