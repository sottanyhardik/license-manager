"""Data migration: create/activate the three additional E132 planning-item
masters (NUT & NUTS, RAISIN, CEREALS FLAKES) and link them to the E132 SION norm
class. Idempotent; runs automatically on deploy so the masters the E132 planning
classifier expects always exist and are active.
...
# Frozen at this migration; must match the additions in e132_plan.PLANNING_ORDER.
E132_EXTRA_PLANNING_ITEMS = (
    "NUT & NUTS - E132",
    "RAISIN - E132",
    "CEREALS FLAKES - E132",
)
...
def seed(apps, schema_editor):
    ...
    # Continue the display_order after the six seeded in 0007.
    for order, name in enumerate(E132_EXTRA_PLANNING_ITEMS, start=7):
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0007_seed_e132_plan_items"),
    ]
