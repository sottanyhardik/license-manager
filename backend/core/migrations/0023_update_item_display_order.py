...
def update_items(apps, schema_editor):
    ...
    e5_items_config = [
        ...
        ('LEAVENING AGENT - E5', 5, 10, True),
        ('FRUIT JUICE - E5', 6, 10, True),
        ('FOOD FLAVOUR - E5', 7, 10, True),
        ('DIETARY FIBRE - E5', 8, 10, True),
        ('FRUIT/COCOA - E5', 9, 10, True),
        ('STARCH 1108 - E5', 10, 10, True),
        ('CHEESE - E5', 11, 10, True),
        ('SWP - E5', 12, 0.00, True),
        ('WPC - E5', 13, 0.00, True),
